  ...
  return (
    <footer className='w-full mb-[100px] md:mb-5 pb-10 ' id='contact'>
        ...
        <div className='flex mt-16 md:flex-row flex-col justify-between items-center'>
            <p className='md:text-base text-sm md:font-normal font-light'>Copyright © 2024 Aakash Rajbhar</p>

            <div className='flex items-center md:gap-3 gap-6 mt-4 md:mt-0'>
                {socialMedia.map((profile) => (
                    <div key={profile.id} className='cursor-pointer w-10 h-10 flex justify-center items-center backdrop-filter backdrop-blur-lg saturate-180 bg-opacity-75 bg-black-200 rounded-lg border-white-200'>
